  ...
  \cventry
    ...
    {2024 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Working on the core payment platform, which facilitates {\textbf{Account Payable}} for Hyperwallet.}
        \item {Designing and developing public-facing APIs with emphasis on {\textbf{developer experience}} and {\textbf{backward compatibility}}, ensuring seamless integration for external partners while maintaining robust versioning strategies.}
      \end{cvitems}
    }
